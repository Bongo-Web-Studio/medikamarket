...
const categories: Category[] = [
  {
    image: "https://ik.imagekit.io/z6mqjyyzz/media/public/rms-x-ray-machine-mdx-100-mcb-12_03_2025-6d5ab558.png?tr=w-150,q-60,f-avif",
    bg: "bg-[#B2EBF2]",
  ...
  {
    image: "https://ik.imagekit.io/z6mqjyyzz/media/public/157a20d093ea46399_image.png?tr=w-150,q-60,f-avif ",
    bg: "bg-[#FFF59D]",
  ...
  {
    image: "https://ik.imagekit.io/z6mqjyyzz/media/public/comen-syringe-pump-3inch-lcd-screen-m260-05_06_2025-a8b397c4.png?tr=w-150,q-60,f-avif",
    bg: "bg-[#FFCCBC]",
  ...
  {
    image: "https://ik.imagekit.io/z6mqjyyzz/media/public/prism-led-ot-light-constella-c-single-dome-ceiling-mountmobile-stand-epmd_otl_cons_c-30__HvHfOsP.jpg?tr=w-150,q-60,f-avif",
    bg: "bg-[#F8BBD0]",
  ...
  {
    image: "https://ik.imagekit.io/z6mqjyyzz/media/public/224f4f0c3ab94c66a_5870.png?tr=w-150,q-60,f-avif",
    bg: "bg-[#BBDEFB]",
  ...
  {
    image: "https://ik.imagekit.io/z6mqjyyzz/media/public/b62e3a581bd44dd5a_image.png?tr=w-150,q-60,f-avif",
    bg: "bg-[#FFE082]",
    test: "Ferritin Serum",
    price: 699,
    originalPrice: 1000,
...
export default function MedicalequipmentsSection(): React.ReactElement {
  ...
  return (
    <div className="relative mx-auto py-10 select-none border-t border-gray-200 w-full h-full overflow-hidden">
      ...
      >
      <span className="">  Popular Medicale</span> <span    className="text-[#6E6E73]"> Equipment</span>
      </h2>
          ...
          <div className="relative ml-12">
            <Swiper
              ...
              breakpoints={{
                ...
                1280: { slidesPerView: 4.5, spaceBetween: 20 }, // desktops
              }}
              navigation={false}
              loop={false}
              className="w-[98vw] rounded-4xl bg-[#F8BBD0] h-[61vh]"
            >
              {extendedCategories.map((cat, idx) => (
                <SwiperSlide key={idx}>
                  <div className=" ml-5 w-full mt-5 max-w-[350px] h-[460px] bg-white  shadow-md rounded-3xl hover:shadow-xl transition-all duration-300 flex flex-col group justify-between mx-auto overflow-hidden">
                    {cat.viewAll ? (
                      <div className="flex flex-col justify-center items-center h-full text-[#155DFC]   rounded-2xl">
