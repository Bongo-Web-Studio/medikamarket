...
const categories: Category[] = [
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/33348f4baf45430d9_MB_Gloves_Pouch__Bulk_Box.png?tr=w-150,q-60,f-avif",
    bg: "bg-[#B2EBF2]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/mb-latex-examination-gloves-pre-powdered-small-pack-of-100-23_09_2025-467e3250.png?tr=w-150,q-60,f-avif  ",
    bg: "bg-[#FFF59D]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/mb-latex-medical-examination-gloves-large-pack-of-100-26_09_2025-d929f06f.jpg?tr=w-150,q-60,f-avif",
    bg: "bg-[#FFCCBC]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/mb-algard-r-82-surface-disinfectant-5l-17_03_2025-fd949a60.jpg?tr=w-150,q-60,f-avif",
    bg: "bg-[#F8BBD0]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/orthocare-relifix-cannula-fixator-set-of-one-pack-0f-100-11_02_2025-5d0a7368.jpg?tr=w-150,q-60,f-avif",
    bg: "bg-[#BBDEFB]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/ab2d6350c02f4681a_IV_Set_Vented.jpg?tr=w-150,q-60,f-avif",
    bg: "bg-[#FFE082]",
    test: "Ferritin Serum",
    price: 699,
    originalPrice: 1000,
...
export default function ConsumablesSection(): React.ReactElement {
  ...
  return (
    <div className="relative mx-auto py-10  select-none border-t border-gray-200 w-full h-full overflow-hidden">
      <h2 className="text-start text-2xl lg:text-4xl  mb-6 px-4 lg:ml-10    text-black font-semibold">
        <span className=""> Popular Consumables.</span>
      ...
      <div className="relative ml-0  lg:ml-12">
        <Swiper
          ...
          navigation={false}
          loop={false}
          className="w-[98vw]  h-[63vh] lg:h-[68vh] bg-[#FFCCBC] rounded-4xl"
        >
