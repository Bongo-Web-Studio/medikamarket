...
const categories: Category[] = [
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/vital-hemodialysis-blood-tubing-set-post-pump-with-tp-pack-of-30-10_04_2025-173a53ab.png?tr=w-150,q-60,f-avif",
    bg: "bg-[#B2EBF2]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/26d00ef475674578a_ELISIO-.jpg?tr=w-150,q-60,f-avif  ",
    bg: "bg-[#FFF59D]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/860345b118544b6fb_image.png?tr=w-150,q-60,f-avif",
    bg: "bg-[#FFCCBC]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/fresenius-plasma-filter-adapter-pack-of-1-10_04_2025-030f9ef2.png?tr=w-150,q-60,f-avif",
    bg: "bg-[#F8BBD0]",
  ...
  {
    image:
      "https://ik.imagekit.io/z6mqjyyzz/media/public/default_images/Dialysis_Machines_74htpEB.png?tr=q-60,f-avif",
    bg: "bg-[#FFE082]",
    test: "Ferritin Serum",
    price: 699,
    originalPrice: 1000,
...
export default function NephrologySection(): React.ReactElement {
    ...
    <div className="relative mx-auto py-10  select-none border-t border-gray-200 w-full h-full overflow-hidden">
      ...
      <div className="relative ml-12">
        <Swiper
          ...
          navigation={false}
          loop={false}
          className="w-[98vw]  h-[61vh] bg-[#FFE082] rounded-4xl "
        >
          {extendedCategories.map((cat, idx) => (
            <SwiperSlide key={idx}>
              <div className="ml-5 mt-5 w-full max-w-[350px] h-[460px]   shadow-md rounded-3xl bg-white hover:shadow-xl transition-all duration-300 flex flex-col group justify-between mx-auto overflow-hidden">
                {cat.viewAll ? (
