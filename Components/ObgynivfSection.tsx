...
export default function ObgynivfSection(): React.ReactElement {
  ...
  return (
    <div className="relative mx-auto py-10 bg-white select-none border-t border-gray-200">
      ...
      >
      <span className="">  Popular Obgynivf</span> <span  style={{ fontFamily: "Neuehaasgrotdisp46lightitalic" }}   className="text-[#155DFC]">• Equipment</span>
      </h2>
